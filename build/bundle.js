(function () {
    ...
    ***************************************************************************** */
    ...
    let n="undefined"!==typeof BigUint64Array,p=Symbol();function r(a,b){var c=new Uint32Array(a);a=new Uint16Array(a);c=c[b+-4>>>2]>>>1;b>>>=1;if(1024>=c)return String.fromCharCode.apply(String,a.subarray(b,b+c));let d="";do{var g=a[b+1024-1];g=55296<=g&&56320>g?1023:1024;d+=String.fromCharCode.apply(String,a.subarray(b,b+=g));c-=g;}while(1024<c);return d+String.fromCharCode.apply(String,a.subarray(b,b+c))}
    function u(a){function b(a,b){return a?r(a.buffer,b):"<yet unknown>"}let c={},d=a.env=a.env||{};d.abort=d.abort||function(a,e,h,k){let l=c.memory||d.memory;throw Error(`abort: ${b(l,a)} at ${b(l,e)}:${h}:${k}`);};d.trace=d.trace||function(a,e,...h){console.log(`trace: ${b(c.memory||d.memory,a)}${e?" ":""}${h.slice(0,e).join(", ")}`);};d.seed=d.seed||Date.now;a.Math=a.Math||Math;a.Date=a.Date||Date;return c}
    function v(a,b){function c(a){{var b=a;let f=new Uint32Array(l.buffer),c=f[t>>>2];if((b>>>=0)>=c)throw Error(`invalid id: ${b}`);b=f[(t+4>>>2)+2*b];}if(!(b&7))throw Error(`not an array: ${a}, flags=${b}`);return b}function d(a,b,c){let f=l.buffer;if(c)switch(a){case 2:return new Float32Array(f);case 3:return new Float64Array(f)}else switch(a){case 0:return new (b?Int8Array:Uint8Array)(f);case 1:return new (b?Int16Array:Uint16Array)(f);case 2:return new (b?Int32Array:Uint32Array)(f);case 3:return new (b?
    BigInt64Array:BigUint64Array)(f)}throw Error(`unsupported align: ${a}`);}function g(a){let b=new Uint32Array(l.buffer),f=c(b[a+-8>>>2]),q=31-Math.clz32(f>>>6&31),e=f&4?a:b[a+4>>>2];a=f&2?b[a+12>>>2]:b[e+-4>>>2]>>>q;return d(q,f&2048,f&4096).subarray(e>>>=q,e+a)}function e(a,b,c){return new a(h(a,b,c))}function h(a,b,c){let f=l.buffer,d=new Uint32Array(f);c=d[c+4>>>2];return new a(f,c,d[c+-4>>>2]>>>b)}function k(b,c,d){a[`__get${c}`]=e.bind(null,b,d);a[`__get${c}View`]=h.bind(null,b,d);}b=b.exports;
    let l=b.memory,m=b.table,q=b.__alloc,y=b.__retain,t=b.__rtti_base||-1;a.__allocString=function(a){let b=a.length,c=q(b<<1,1),d=new Uint16Array(l.buffer);for(var f=0,e=c>>>1;f<b;++f)d[e+f]=a.charCodeAt(f);return c};a.__getString=function(a){let b=l.buffer;if(1!==(new Uint32Array(b))[a+-8>>>2])throw Error(`not a string: ${a}`);return r(b,a)};a.__allocArray=function(a,b){var f=c(a);let e=31-Math.clz32(f>>>6&31),k=b.length,h=q(k<<e,f&4?a:0);if(f&4)a=h;else {a=q(f&2?16:12,a);var g=new Uint32Array(l.buffer);
    g[a+0>>>2]=y(h);g[a+4>>>2]=h;g[a+8>>>2]=k<<e;f&2&&(g[a+12>>>2]=k);}g=d(e,f&2048,f&4096);if(f&16384)for(f=0;f<k;++f)g[(h>>>e)+f]=y(b[f]);else g.set(b,h>>>e);return a};a.__getArrayView=g;a.__getArray=function(a){a=g(a);let b=a.length,c=Array(b);for(let d=0;d<b;d++)c[d]=a[d];return c};a.__getArrayBuffer=function(a){let b=l.buffer,c=(new Uint32Array(b))[a+-4>>>2];return b.slice(a,a+c)};[Int8Array,Uint8Array,Uint8ClampedArray,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array].forEach(a=>
    {k(a,a.name,31-Math.clz32(a.BYTES_PER_ELEMENT));});n&&[BigUint64Array,BigInt64Array].forEach(a=>{k(a,a.name.slice(3),3);});a.__instanceof=function(a,b){var c=new Uint32Array(l.buffer);a=c[a+-8>>>2];if(a<=c[t>>>2]){do{if(a==b)return !0;{c=a;a=new Uint32Array(l.buffer);let b=a[t>>>2];if((c>>>=0)>=b)throw Error(`invalid id: ${c}`);a=a[(t+4>>>2)+2*c+1];}}while(a)}return !1};a.memory=a.memory||l;a.table=a.table||m;return w(b,a)}function x(a){return "undefined"!==typeof Response&&a instanceof Response}
    async function z(a,b={}){if(x(a=await a))return A(a,b);a=a instanceof WebAssembly.Module?a:await WebAssembly.compile(a);var c=u(b);b=await WebAssembly.instantiate(a,b);c=v(c,b);return {module:a,instance:b,exports:c}}function B(a,b={}){a=a instanceof WebAssembly.Module?a:new WebAssembly.Module(a);var c=u(b);b=new WebAssembly.Instance(a,b);c=v(c,b);return {module:a,instance:b,exports:c}}
    async function A(a,b={}){if(!WebAssembly.instantiateStreaming)return z(x(a=await a)?a.arrayBuffer():a,b);var c=u(b);a=await WebAssembly.instantiateStreaming(a,b);c=v(c,a.instance);return {...a,exports:c}}var C=A;
    function w(a,b={}){b=Object.create(b);let c=a.__argumentsLength?b=>{a.__argumentsLength.value=b;}:a.__setArgumentsLength||a.__setargc||(()=>{});for(let e in a){if(!Object.prototype.hasOwnProperty.call(a,e))continue;let h=a[e];var d=e.split(".");let k=b;for(;1<d.length;){var g=d.shift();Object.prototype.hasOwnProperty.call(k,g)||(k[g]={});k=k[g];}d=d[0];g=d.indexOf("#");if(0<=g){let b=d.substring(0,g),m=k[b];if("undefined"===typeof m||!m.prototype){let a=function(...b){return a.wrap(a.prototype.constructor(0,
    ...b))};a.prototype={valueOf(){return this[p]}};a.wrap=function(b){return Object.create(a.prototype,{[p]:{value:b,writable:!1}})};m&&Object.getOwnPropertyNames(m).forEach(b=>Object.defineProperty(a,b,Object.getOwnPropertyDescriptor(m,b)));k[b]=a;}d=d.substring(g+1);k=k[b].prototype;if(/^(get|set):/.test(d)){if(!Object.prototype.hasOwnProperty.call(k,d=d.substring(4))){let b=a[e.replace("set:","get:")],c=a[e.replace("get:","set:")];Object.defineProperty(k,d,{get(){return b(this[p])},set(a){c(this[p],
    a);},enumerable:!0});}}else "constructor"===d?(k[d]=(...a)=>{c(a.length);return h(...a)}).original=h:(k[d]=function(...a){c(a.length);return h(this[p],...a)}).original=h;}else /^(get|set):/.test(d)?Object.prototype.hasOwnProperty.call(k,d=d.substring(4))||Object.defineProperty(k,d,{get:a[e.replace("set:","get:")],set:a[e.replace("get:","set:")],enumerable:!0}):"function"===typeof h&&h!==c?(k[d]=(...a)=>{c(a.length);return h(...a)}).original=h:k[d]=h;}return b}
    async function D(a,b){let c=a instanceof Promise;c&&(a=await a);return (c?await C(a,b):await z(a,b)).exports}let E=["__alloc","__allocString","__retain","__release"];
    function F(a,b){if("object"!==typeof a)throw Error("Did not pass a valid exports object of the WebAssembly Instance");if("function"!==typeof b)throw Error("Did not pass a valid exported function of the WebAssembly Instance");E.forEach(b=>{if(!a[b])throw Error('Required Exported AssemblyScript Runtime functions are not present. Runtime must be set to "full" or "stub"');});}
    let G=(a,b)=>({ptr:b,value:a}),H={STRING:{isTypeFromArgument:a=>"string"===typeof a,isTypeFromReference:(a,b)=>a.__instanceof(b,a.__asbind_String_ID),getRef:(a,b)=>a.__retain(a.__allocString(b)),getValueFromRef:(a,b)=>a.__getString(b)},INT8ARRAY:{isTypeFromArgument:a=>a instanceof Int8Array,isTypeFromReference:(a,b)=>a.__instanceof(b,a.__asbind_Int8Array_ID),getRef:(a,b)=>a.__retain(a.__allocArray(a.__asbind_Int8Array_ID,b)),getValueFromRef:(a,b)=>a.__getInt8Array(b),getUnsafeValueFromRef:(a,b)=>
    G(a.__getInt8ArrayView(b),b)},UINT8ARRAY:{isTypeFromArgument:a=>a instanceof Uint8Array,isTypeFromReference:(a,b)=>a.__instanceof(b,a.__asbind_Uint8Array_ID),getRef:(a,b)=>a.__retain(a.__allocArray(a.__asbind_Uint8Array_ID,b)),getValueFromRef:(a,b)=>a.__getUint8Array(b),getUnsafeValueFromRef:(a,b)=>G(a.__getUint8ArrayView(b),b)},INT16ARRAY:{isTypeFromArgument:a=>a instanceof Int16Array,isTypeFromReference:(a,b)=>a.__instanceof(b,a.__asbind_Int16Array_ID),getRef:(a,b)=>a.__retain(a.__allocArray(a.__asbind_Int16Array_ID,
    b)),getValueFromRef:(a,b)=>a.__getInt16Array(b),getUnsafeValueFromRef:(a,b)=>G(a.__getInt16ArrayView(b),b)},UINT16ARRAY:{isTypeFromArgument:a=>a instanceof Uint16Array,isTypeFromReference:(a,b)=>a.__instanceof(b,a.__asbind_Uint16Array_ID),getRef:(a,b)=>a.__retain(a.__allocArray(a.__asbind_Uint16Array_ID,b)),getValueFromRef:(a,b)=>a.__getUint16Array(b),getUnsafeValueFromRef:(a,b)=>G(a.__getUint16ArrayView(b),b)},INT32ARRAY:{isTypeFromArgument:a=>a instanceof Int32Array,isTypeFromReference:(a,b)=>a.__instanceof(b,
    a.__asbind_Int32Array_ID),getRef:(a,b)=>a.__retain(a.__allocArray(a.__asbind_Int32Array_ID,b)),getValueFromRef:(a,b)=>a.__getInt32Array(b),getUnsafeValueFromRef:(a,b)=>G(a.__getInt32ArrayView(b),b)},UINT32ARRAY:{isTypeFromArgument:a=>a instanceof Uint32Array,isTypeFromReference:(a,b)=>a.__instanceof(b,a.__asbind_Uint32Array_ID),getRef:(a,b)=>a.__retain(a.__allocArray(a.__asbind_Uint32Array_ID,b)),getValueFromRef:(a,b)=>a.__getUint32Array(b),getUnsafeValueFromRef:(a,b)=>G(a.__getUint32ArrayView(b),
    b)},FLOAT32ARRAY:{isTypeFromArgument:a=>a instanceof Float32Array,isTypeFromReference:(a,b)=>a.__instanceof(b,a.__asbind_Float32Array_ID),getRef:(a,b)=>a.__retain(a.__allocArray(a.__asbind_Float32Array_ID,b)),getValueFromRef:(a,b)=>a.__getFloat32Array(b),getUnsafeValueFromRef:(a,b)=>G(a.__getFloat32ArrayView(b),b)},FLOAT64ARRAY:{isTypeFromArgument:a=>a instanceof Float64Array,isTypeFromReference:(a,b)=>a.__instanceof(b,a.__asbind_Float64Array_ID),getRef:(a,b)=>a.__retain(a.__allocArray(a.__asbind_Float64Array_ID,
    b)),getValueFromRef:(a,b)=>a.__getFloat64Array(b),getUnsafeValueFromRef:(a,b)=>G(a.__getFloat64ArrayView(b),b)}};
    function I(a,b,c){function d(){const d=a.unboundExports;h===b&&(h=g(b,[...c]));const l=[];Array.prototype.slice.call(arguments).forEach((a,b)=>{let c=void 0;h.shouldCacheTypes&&h.cachedArgTypes[b]&&"ref"===h.cachedArgTypes[b].type?c=H[h.cachedArgTypes[b].key]:Object.keys(H).some(e=>H[e].isTypeFromReference(d,a)?(c=H[e],h.shouldCacheTypes&&(h.cachedArgTypes[b]={type:"ref",key:e}),!0):!1);c?l.push(c.getValueFromRef(d,a)):l.push(a);});return e.apply(null,l)}let g=(a,b)=>{a=a[b[0]];b.shift();return 0<
    b.length?g(a,b):a},e=g(b,[...c]),h=b;d.shouldCacheTypes=!0;d.cachedArgTypes=[];return d}
    function J(a,b){function c(){var c=Array.prototype.slice.call(arguments);e===a.exports&&(e=a.exports[b]);const k=[],l=[];c.forEach((a,b)=>{if("number"===typeof a)k.push(a),e.shouldCacheTypes&&(e.cachedArgTypes[b]={type:"number"});else {var c=void 0;if(e.shouldCacheTypes&&e.cachedArgTypes[b]&&"ref"===e.cachedArgTypes[b].type)c=H[e.cachedArgTypes[b].key];else if(Object.keys(H).some(d=>H[d].isTypeFromArgument(a)?(c=H[d],e.shouldCacheTypes&&(e.cachedArgTypes[b]={type:"ref",key:d}),!0):!1),!c)throw Error(`The argument, ${a}, is not a supported type by asbind`);
    k.push(c.getRef(d,a));l.push(b);}});const m=g.apply(null,k);l.forEach(a=>{d.__release(k[a]);});c=void 0;if(void 0!==m){let a=void 0;e.shouldCacheTypes&&e.cachedReturnTypes[0]?"ref"===e.cachedReturnTypes[0].type&&(a=a=H[e.cachedReturnTypes[0].key]):Object.keys(H).some(b=>H[b].isTypeFromReference(d,m)?(a=H[b],e.shouldCacheTypes&&(e.cachedReturnTypes[0]={type:"ref",key:b}),!0):!1);a?c=e.unsafeReturnValue&&a.getUnsafeValueFromRef?a.getUnsafeValueFromRef(d,m):a.getValueFromRef(d,m):"number"===typeof m&&
    (c=m,e.shouldCacheTypes&&(e.cachedReturnTypes[0]={type:"number"}));}return c}let d=a.unboundExports,g=d[b];F(d,g);let e=a.exports;c.shouldCacheTypes=!0;c.unsafeReturnValue=!1;c.cachedArgTypes=[];c.cachedReturnTypes=[];return c}let K=(a,b,c)=>{a&&Object.keys(a).forEach(d=>{"function"===typeof a[d]?c(a,b,d):"object"===typeof a[d]&&K(a[d],[...b,d],c);});};
    class L{constructor(){this.unboundExports={};this.exports={};this.importObject={};}async _instantiate(a,b){this._instantiateBindImportFunctions(b);a=await D(a,this.importObject);this._instantiateBindUnboundExports(a);}_instantiateSync(a,b){this._instantiateBindImportFunctions(b);a=B(a,this.importObject).exports;this._instantiateBindUnboundExports(a);}_instantiateBindImportFunctions(a){this.importObject=a;K(this.importObject,[],(a,c,d)=>{a[`__asbind_unbound_${d}`]=a[d];a[d]=I(this,this.importObject,[...c,
    d]);});}_instantiateBindUnboundExports(a){this.unboundExports=a;if(!this.unboundExports.__asbind_entryfile_flag||0===this.unboundExports.__asbind_entryfile_flag)throw Error("as-bind: The instantiated AssemblyScript wasm module was not built with the as-bind entryfile. Please see the as-bind documentation (Quick Start), and rebuild your AssemblyScript wasm module.");this.exports={};Object.keys(this.unboundExports).forEach(a=>{var b;if(b="function"===typeof this.unboundExports[a])b=a.startsWith("__asbind")?
    !0:E.includes(a)?!0:!1,b=!b;this.exports[a]=b?J(this,a):this.unboundExports[a];});}enableExportFunctionTypeCaching(){Object.keys(this.exports).forEach(a=>{this.exports[a].shouldCacheTypes=!0;});}disableExportFunctionTypeCaching(){Object.keys(this.exports).forEach(a=>{this.exports[a].shouldCacheTypes=!1;});}enableExportFunctionUnsafeReturnValue(){Object.keys(this.exports).forEach(a=>{this.exports[a].unsafeReturnValue=!0;});}disableExportFunctionUnsafeReturnValue(){Object.keys(this.exports).forEach(a=>{this.exports[a].unsafeReturnValue=
    !1;});}enableImportFunctionTypeCaching(){K(this.importObject,[],(a,b,c)=>{a[c].shouldCacheTypes=!0;});}disableImportFunctionTypeCaching(){K(this.importObject,[],(a,b,c)=>{a[c].shouldCacheTypes=!1;});}}let M={version:"0.4.1",instantiate:async(a,b)=>{let c=new L;await c._instantiate(a,b);return c},instantiateSync:(a,b)=>{let c=new L;c._instantiateSync(a,b);return c}};
...
`;
    ...
    var defaultTickRate = 7;
    function getRoms() {
        return __awaiter(this, void 0, void 0, function () {
            var r, roms, id, tree, _i, _a, item, url, filename, title, txtUrl;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4, fetch("https://raw.githubusercontent.com/JohnEarnest/chip8Archive/master/programs.json")];
                    case 1:
                        r = _b.sent();
                        return [4, r.json()];
                    case 2:
                        ...
                        return [4, fetch("https://api.github.com/repos/dmatlack/chip8/git/trees/master?recursive=1")];
                    case 3:
                        r = _b.sent();
                        return [4, r.json()];
                    case 4:
                        tree = _b.sent();
                        for (_i = 0, _a = tree.tree; _i < _a.length; _i++) {
                            item = _a[_i];
                            if (!item.path.endsWith(".ch8"))
                                continue;
                            url = "https://github.com/dmatlack/chip8/tree/master/" + item.path;
                            filename = url.split("/").slice(-1)[0];
                            title = filename.replace(".ch8", "");
                            txtUrl = url.replace(' (alt)', '');
    ...
    var buzzer;
    var offColor = [0, 0, 0];
    var onColor = [255, 255, 255];
    var turboBtn = document.getElementById('turbo-btn');
    function main() {
        return __awaiter(this, void 0, void 0, function () {
            var imports, module, sortedRoms, romSelector, _i, sortedRoms_1, _a, romId, rom, option, romInfo, loadRomBtn, urlParams;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        imports = {};
                        return [4, M.instantiate(fetch("./build/untouched.wasm"), imports)];
                    case 1:
                        module = _b.sent();
                    ...
                    case 2:
                        roms = _b.sent();
                        sortedRoms = Object.entries(roms).sort(function (_a, _b) {
                            var romA = _a[1];
                            var romB = _b[1];
                            return romA.title.localeCompare(romB.title);
                        });
                        romSelector = document.getElementById('rom-selector');
                        for (_i = 0, sortedRoms_1 = sortedRoms; _i < sortedRoms_1.length; _i++) {
                            _a = sortedRoms_1[_i], romId = _a[0], rom = _a[1];
                        ...
                        loadRomBtn.addEventListener('click', function () { return __awaiter(_this, void 0, void 0, function () {
                            var romId, rom, description, r;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4, start()];
                                    case 1:
                                        _a.sent();
                                        buzzer = new Oscillator({
                                            type: "square",
                                            frequency: 200,
                                            volume: -25
                                        }).toDestination();
                                        romId = romSelector.value;
                                        loadRom(romId);
                                        rom = roms[romId];
                                        description = '';
                                        if (!rom.desc) return [3, 2];
                                        description = rom.desc;
                                        return [3, 5];
                                    case 2:
                                        if (!rom.txtUrl) return [3, 5];
                                        return [4, fetch(rom.txtUrl)];
                                    case 3:
                                        r = _a.sent();
                                        if (!r.ok) return [3, 5];
                                        return [4, r.text()];
                        ...
                        log$1 = urlParams.get('log') == '1';
                        if (log$1) {
                            console.log(exports$1.getInstructionTypes());
                        }
                        document.addEventListener('keydown', function (e) {
                            var chip8Key = keyMap[e.code];
    ...
    function step() {
        var raster = exports$1.getDisplayRaster().value;
        ...
        if (log$1) {
            console.log('ram', exports$1.getRam().value);
            console.log('raster', raster);
            console.log('keys', bin(unboundExports.getKeys()));
            console.log('register V', exports$1.getVRegisters().value);
            console.log('register I', hex(unboundExports.getIRegister()));
            console.log('register DT', exports$1.getDTRegister());
            console.log('register ST', exports$1.getSTRegister());
            console.log('register PC', hex(unboundExports.getPCRegister()));
            console.log('register SP', exports$1.getSPRegister());
            console.log('register stack', exports$1.getStackRegister().value);
            console.log("instruction: " + exports$1.getInstructionTypeName() + " " + exports$1.getInstructionParameters());
        }
        try {
            exports$1.stepCPU();
        }
    ...
    function loadRom(romId) {
        return __awaiter(this, void 0, void 0, function () {
            var rom, romResponse, romBuf;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        window.clearInterval(timer);
                        rom = roms[romId];
                        return [4, fetch(rom.romUrl)];
                    case 1:
                        romResponse = _a.sent();
                        return [4, romResponse.arrayBuffer()];
                    case 2:
                        romBuf = _a.sent();
                        exports$1.init();
                        exports$1.loadProgram(new Uint8Array(romBuf));
